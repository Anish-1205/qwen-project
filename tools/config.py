...
WEB_SEARCH_MAX_RESULTS = _bounded_int("TOOLS_WEB_SEARCH_MAX_RESULTS", 10, 1, 10)
WEB_SEARCH_DEFAULT_RESULTS = _bounded_int("TOOLS_WEB_SEARCH_DEFAULT_RESULTS", 5, 1, WEB_SEARCH_MAX_RESULTS)
WEB_SEARCH_MAX_QUERY_CHARS = _bounded_int("TOOLS_WEB_SEARCH_MAX_QUERY_CHARS", 500, 20, 2_000)
WEB_SEARCH_MAX_RESPONSE_BYTES = _bounded_int("TOOLS_WEB_SEARCH_MAX_RESPONSE_BYTES", 512_000, 16_384, 2_000_000)
WEB_SEARCH_MAX_TITLE_CHARS = _bounded_int("TOOLS_WEB_SEARCH_MAX_TITLE_CHARS", 300, 50, 1_000)
WEB_SEARCH_MAX_SNIPPET_CHARS = _bounded_int("TOOLS_WEB_SEARCH_MAX_SNIPPET_CHARS", 1_000, 100, 5_000)
